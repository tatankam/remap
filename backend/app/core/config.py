...
# --- LOMBARDIA REGION ---
LOMBARDIA_API_ENDPOINT = os.getenv("LOMBARDIA_API_ENDPOINT")
LOMBARDIA_PROVIDER_PREFIX = os.getenv("LOMBARDIA_PROVIDER_PREFIX")
LOMBARDIA_API_LIMIT = os.getenv("LOMBARDIA_API_LIMIT", "10000")